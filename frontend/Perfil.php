                    ...
                    <div class="row z-depth-3">
                        <div class="col-sm-4 bg-info rounded-left">
                            <div class="card-block text-center text-dark">
                                ...
                                <h2 class="font-weight-bold mt-4">Juan CHS99</h2>
                        ...
                        <div class="col-sm-8 bg-white rounded-right">
                            ...
                            <hr class="bg-primary">
                                ...
                                <div class="col-sm-6">
                                        ...
                                        <h6 class="text-muted">Juan Camilo</h6>
                                    </div>
                                    <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <h6 class="text-muted">prueba@gmail.com</h6>
                                    </div>
                                    <div class="col-sm-6">
                                        <p class="font-weight-bold">Id:</p>
                                        <h6 class="text-muted">1032504823</h6>
                                    </div>
                                </div>
                            <hr class="bg-primary">
