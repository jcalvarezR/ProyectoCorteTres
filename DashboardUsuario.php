    ...
    <!-- seccion barra zona izquierda-->
        ...
        <div id="sidebar-container" class="bg-primary">
            ...
            <div class="menu">
                ...
                <a href="Dashboard.php" class="d-block text-light p-3"><i class="icon ion-md-home mr-2 lead"></i>Inicio</a>
                ...
                <a href="DashboardPcopia.php" class="d-block text-light p-3"><i class="icon ion-md-hand"></i> Pedir Copia</a>
            ...
            <section class="py-3">
                <div class="container">
                    <div class="row">
                            ...
                            <div class="col-lg-9">
                                <h1 class="font-weight-bold mb-0">Bienvenido/a a <b><i>Wanote</i> <?php echo $row['nombre'] ?>   </b></h1>
...
<div id="templatemo_content_right">
        	<div class="templatemo_product_box">
                ...
                <div class="product_info">
                  ...
                  <h3>Agotado</h3>
                    <div class="buy_now_button"><a href="Dashboard Pcopia.html">Reserva</a></div>
